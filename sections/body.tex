...
the community available through the Campus Champion program (\url{https://www.xsede.org/web/campus-champions}).
...
projects. These both use Kubernetes Helm Charts (\url{https://github.com/kubernetes/charts}) to
...
(\url{https://zero-to-jupyterhub-with-kubernetes.readthedocs.io},
