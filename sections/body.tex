...
#Ariel showing an jupyter notebook in class: https://www.dropbox.com/s/tfcymiqhh5nlvkm/ariel_ucsf2017.jpg?dl=0
...
An extra benefit of this approach is the "mobility of computing", as individuals have
the ability to perfectly replicate the course on any new computing environment. With
a few Docker commands, it is possible to recreate the user experience on
...
new materials based on the Docker images of the course, which encourages collaboration
...
these resources \aaron{or provide Jetstream-like cloud computing resources at the
campus-level}.
